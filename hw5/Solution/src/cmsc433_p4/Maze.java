...
public class Maze implements Serializable {
	 ...
	 *      bit combinations corresponds to a different color that will be used by the cmsc433_p4.MazeDisplay object
	...
	// cmsc433_p4.Position variables used internally.  Allocated once here to avoid excessive memory allocation.
