...
/**
 * cmsc433_p4.Main entry point for the program. Provides command-line support for
...
public class Main
{
    ...
    public void solve()
    {
        ...
        {
            if (solver instanceof  STMazeSolverDFS){
...
//        }
    ...
    private void initDisplay()
    {
        ...
        if (cell_size >= 2)
        {
            JFrame frame = new JFrame("cmsc433_p4.Maze Solver");
        ...
        {
            System.out.println("cmsc433_p4.Maze too large to display on-screen.");
        }
    }
}
